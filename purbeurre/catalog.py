...
class TheMenu:
    ...
    def display_subcategories(self):
        ...
        for cat in list_cat:
            print(colored(cat[0], "green"), cat[1], sep=" : ", end=" | ")
        print(
        ...
        try:
            ...
            test = [
                item for item in list_cat if item[0] == sub_category_number
            ]
            if test != []:
    ...
    def products_from_selected_subcategory(self):
        ...
        if answer == "1":
            ...
            try:
                product_to_substitute = int(
                    input("Saisissez le numéro de l'aliment à substituer : ")
                )
            except ValueError:
                print("Saisie incorrecte !")
                input("Appuyez sur 'Entrée' pour continuer.")
    ...
    def save_product(self):
        ...
        print(
            ...
            + " (Score : ",
            colored(info_product_score, "yellow"),
        ...
        if answer == "1":
            self.prod_manage.record_product(
                self.old_product_bar_code, new_product
            )
            return self.accueil
        elif answer == "2":
            return self.product_substitution
    ...
    def stored_product(self):
        ...
        for product in save_product:
            print(
                "Produit d'origine",
                colored(product[0][0], "red"),
                "\n" + "Description :",
                product[0][1] + " de score :",
                colored(product[0][2], "red"),
                "\n" + "Remplacé par :",
            )
            i = 0
            while i < len(product[1]):
                ...
                print(
                    ...
                    "\n" + "Description :",
                    product[1][i][1] + " de score :",
                    colored(product[1][i][2], "green"),
                )
                i += 1
            print("-----------------------")
        print(
